...
class EndedAuctions extends StatefulWidget {
  const EndedAuctions({super.key});

  @override
  State<EndedAuctions> createState() => _EndedAuctionsState();
}

class _EndedAuctionsState extends State<EndedAuctions> {
  @override
  Widget build(BuildContext context) {
    TextEditingController searchController = TextEditingController();

    return Scaffold(
      appBar: MyAppBar(title: "Ended Auctions"),
      body: Padding(
        padding: myPadding,
        child: Column(
          children: [
