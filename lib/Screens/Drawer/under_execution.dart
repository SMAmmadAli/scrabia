...
class UnderExecution extends StatefulWidget {
  const UnderExecution({super.key});

  @override
  State<UnderExecution> createState() => _UnderExecutionState();
}

class _UnderExecutionState extends State<UnderExecution> {
  @override
  Widget build(BuildContext context) {
    TextEditingController searchController = TextEditingController();

    return Scaffold(
      appBar: MyAppBar(title: "Under Execution"),
      body: Padding(
        padding: myPadding,
        child: Column(
          children: [
