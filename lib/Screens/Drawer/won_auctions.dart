...
class WonAuctions extends StatefulWidget {
  const WonAuctions({super.key});

  @override
  State<WonAuctions> createState() => _WonAuctionsState();
}

class _WonAuctionsState extends State<WonAuctions> {
  @override
  Widget build(BuildContext context) {
    TextEditingController searchController = TextEditingController();

    return Scaffold(
      appBar: MyAppBar(title: "Won Auctions"),
      body: Padding(
        padding: myPadding,
        child: Column(
          children: [
